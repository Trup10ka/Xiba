...
{
    public AccountRemoveCommand(@NotNull CommandIdentifier identifier, BankClientsService bankClientsService)
    {
    ...
    {
        boolean result = getBankClientsService().removeClient(0);
        return "";
    }
}
